          ...
          <div className="my-[32px] md:my-[147px] md:w-[550px]">
            ...
            {/* <div className="mt-8 w-full relative ">
              <div className="relative flex items-center ">
                <CiSearch className="absolute left-3 top-1/2 transform -translate-y-1/2 text-gray-400" />
                <input
                  className="rounded-[12px] pl-12 pr-10 py-3 md:py-4 text-[#BBB] placeholder-opacity-100 border-none focus:outline-none bg-[#F6F6F6] w-full "
                  placeholder="Search templates on web, apps, figma, ecommerce and more..."
                />
                <div className="absolute inset-y-0 right-4 flex items-center">
                  <div className="border-l border-gray-300 h-6 mr-1"></div>{" "}
                  <div className="ml-3 relative">
                    <select className="appearance-none border-none bg-transparent text-[#BBB] outline-none pr-8 py-2 pl-1 text-sm md:text-base w-full">
                      <option value="" disabled selected hidden>
                        All Categories
                      </option>
                      <option
