    ...
    <>
      <Transition appear show={isOpen} as={Fragment}>
        ...
        >
          ...
          <div className="fixed inset-0  overflow-y-auto p-4 sidebar-scroll">
            <div className="flex min-h-full items-center md:items-center md:pt-14 justify-center text-center sidebar-scroll">
              ...
              >
                <Dialog.Panel
                  className={`relative w-full ${sizes[size]} bg-white-100 and font-nunito font-light transform overflow-hidden text-sm rounded-[12px] text-left align-middle shadow-xl transition-all`}
                >
                  {title && (
                    <Dialog.Title
                      as="h3"
