...
const LoadingSpinner = () => (
  <div className="flex item-center justify-center mt-[2rem]">Loading...</div>
);
...
async function ResetPasswordPage() {
  ...
  const token = (await useSuspensedSearchParams()).get("token");
...
// Define a custom hook to use Suspense with useSearchParams
function useSuspensedSearchParams() {
